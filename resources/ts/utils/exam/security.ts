/**
 * Utilitaires de sécurité pour les examens
 * 
 * Ce module fournit des fonctions réutilisables pour implémenter
 * les mesures de sécurité pendant les examens en ligne.
 */
