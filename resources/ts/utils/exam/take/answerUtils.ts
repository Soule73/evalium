/**
 * Formats exam answers for backend submission
 * 
...
/**
 * Calculates exam completion percentage
 * 
 ...
 * 
 * @example
 * getExamCompletionPercentage({ 1: [2], 3: 5 }, 10) // 20
 */
export function getExamCompletionPercentage(
    answers: Record<number, string | number | number[]>,
