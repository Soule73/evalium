...
import { type Enrollment, type User, type PageProps } from '@evalium/utils/types';
...
export default function Classmates({ enrollment, classmates }: StudentEnrollmentClassmatesProps) {
    ...
    const classmatesCountTranslation = useMemo(
        () =>
            t('student_enrollment_pages.classmates.classmates_count', { count: classmates.length }),
        [t, classmates.length],
    );
    ...
    return (
        <AuthenticatedLayout
            ...
            breadcrumb={breadcrumbs.student.enrollmentClassmates()}
        >
            <Section
