...
const AssessmentResults: React.FC<Props> = ({
    ...
    const titleTranslation = useMemo(
        () => t('student_assessment_pages.results.title', { assessment: assessment.title }),
        [t, assessment.title],
    );
        ...
        >
            <Section
                ...
                subtitle={
                    <div className="flex items-center space-x-4">
                        <span
                            className={`px-3 py-1 rounded-full text-sm font-medium ${assignmentStatus.color}`}
                        >
            ...
            <Section title={translations.answersDetail}>
                ...
                {!showCorrectAnswers && !showResultsImmediately && isPendingReview && (
                    <AlertEntry
                        title={translations.resultsHiddenTitle}
                        type="warning"
                        className="mb-6"
                    >
