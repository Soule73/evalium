...
import { TextEntry } from '@evalium/ui';
import {
  type Assessment,
...
/**
 * Admin page displaying assessment details within its class context.
 */
const ClassAssessmentShow: React.FC<Props> = ({
  class: classItem,
  assessment,
  assignments,
  routeContext,
  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumb={breadcrumbs.admin.classAssessmentShow(classItem, assessment)}
    >
...
export default ClassAssessmentShow;
