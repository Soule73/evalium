...
export default function UserIndex({ users, roles }: Props) {
    ...
    return (
        ...
        >
            ...
            <Section title={translations.subtitle}
                actions={
                    canCreateUsers && (
                        <Button
            ...
            <ConfirmationModal
                ...
                message={t('admin_pages.users.delete_message', { name: deleteModal.data?.name || '' })}
            ...
            <ConfirmationModal
                ...
                message={t('admin_pages.users.force_delete_message', { name: forceDeleteModal.data?.name || '' })}
