...
export default function GradeAssignment({ assessment, student, assignment, userAnswers = {} }: Props) {
  ...
  const handleConfirmSubmit = useCallback(() => {
    ...
    router.post(route('teacher.assessments.saveGrade', { assessment: assessment.id, assignment: assignment.id }), {
      scores: scoresWithFeedback,
      teacher_notes: teacherNotes
    }, {
      onFinish: () => setIsSubmitting(false)
    });
  }, [assessment, assignment, scores, feedbacks, teacherNotes]);
  ...
  return (
    <AuthenticatedLayout
      ...
      breadcrumb={breadcrumbs.assessmentGrade(assessment, assignment, student)}
    >
