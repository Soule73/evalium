 ...
 */
export function StudentSelectionStep({ selectedClass }: StudentSelectionStepProps) {
    ...
    const config: DataTableConfig<User> = useMemo(
        () => ({
            ...
            columns: [
                ...
                {
                    key: 'previous_class',
                    label: t('admin_pages.enrollments.previous_class'),
                    render: (student) => {
                        const pc = student.previous_class;
                        if (!pc) {
                        ...
                        return (
                            <span className="text-sm text-gray-700">
                                {pc.name}
                                {pc.level && (
                                    <span className="text-gray-400"> ({pc.level.name})</span>
                                )}
                            </span>
                        );
                    },
