...
import { ClassModel, Subject, User, Semester } from '@/types';
...
export function CreateClassSubjectModal({
  ...
  const isFormValid = formValues.class_id !== 0 && formValues.subject_id !== 0 && formValues.teacher_id !== 0;
    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <Input
          ...
          onChange={(e) => setFormValues(prev => ({ ...prev, coefficient: parseFloat(e.target.value) || 0 }))}
