...
interface ClassSubjectDetailProps {
...
/**
 * Shared detail view for a class-subject assignment.
 * Used by both Admin/ClassSubjects/Show and Admin/Classes/SubjectShow pages.
 */
export function ClassSubjectDetail({
    classSubject,
    history,
    teachers,
    permissions,
    ...
    const canUpdate = hasPermission(permissions, 'update class subjects');
