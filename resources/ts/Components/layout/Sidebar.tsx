                            ...
                            <div className="p-2 space-y-2">
                                ...
                                <Tooltip content={t('sidebar.actions.logout')} position="right">
                                    <Link
                                        ...
                                        method="post"
                                        as="button"
                                        className="w-full flex items-center justify-center p-2.5 text-gray-600 bg-gray-100 hover:bg-gray-200 hover:text-gray-800 rounded-lg transition-colors cursor-pointer"
                                    >
                            ...
                            <>
                                ...
                                <div className="px-2 pb-3">
                                    <Link
                                        ...
                                        method="post"
                                        as="button"
                                        className="w-full flex items-center justify-center space-x-2 px-4 py-2.5 text-sm font-medium text-gray-600 bg-gray-100 hover:bg-gray-200 hover:text-gray-800 rounded-lg transition-colors cursor-pointer"
                                    >
