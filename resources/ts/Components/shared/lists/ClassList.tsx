 ...
 */
export function ClassList({ data, variant = 'admin', levels = [], onView }: ClassListProps) {
            ...
            columns: [
                {
                    ...
                    labelKey:
                        variant === 'admin'
                            ? 'admin_pages.classes.name'
                            : 'teacher_class_pages.index.name',
                    render: (classItem) => {
...

                {
                    ...
                    labelKey:
                        variant === 'admin'
                            ? 'admin_pages.classes.students'
                            : 'teacher_class_pages.index.students',
                    render: (classItem, currentVariant) => {
                        ...
                        if (currentVariant === 'admin') {
                            ...
                            const percentage =
                                maxStudents > 0 ? (activeCount / maxStudents) * 100 : 0;
...

                {
                    ...
                    render: (classItem) => (
                        <div className="text-sm text-gray-600">{classItem.subjects_count || 0}</div>
                    ),
