        ...
        const getStatusBadge = (status: string, currentVariant: EntityListVariant) => {
            if (currentVariant === 'student') {
                const statusMap: Record<
                    string,
                    { type: 'success' | 'info' | 'gray'; label: string }
                > = {
                    active: {
                        type: 'success',
                        label: t('student_enrollment_pages.history.active'),
                    },
                    completed: {
                        type: 'info',
                        label: t('student_enrollment_pages.history.completed'),
                    },
                };
            ...
            actions: [
                {
                    ...
                    conditional: (_item: Enrollment, v) =>
                        v === 'admin' && permissions.canView !== false,
                },
            ],
        };
