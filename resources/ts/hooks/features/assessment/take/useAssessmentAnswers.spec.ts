...
const makeQuestion = (overrides: Partial<Question> & { id: number; type: Question['type'] }): Question => ({
  assessment_id: 1,
  content: 'Question',
  points: 5,
  order_index: 1,
...
describe('buildInitialAnswers', () => {
  ...
  it('should restore one_choice answer as single number', () => {
    ...
    const userAnswers = [
      makeAnswer({ id: 1, question_id: 20, choice_id: 200 }),
    ];
  ...
  it('should restore boolean answer as single number', () => {
    ...
    const userAnswers = [
      makeAnswer({ id: 1, question_id: 30, choice_id: 300 }),
    ];
  ...
  it('should restore text answer as string', () => {
    ...
    const userAnswers = [
      makeAnswer({ id: 1, question_id: 40, answer_text: 'My response' }),
    ];
  ...
  it('should skip answers without matching question', () => {
    const questions = [makeQuestion({ id: 1, type: 'text' })];
    const userAnswers = [
      makeAnswer({ id: 1, question_id: 999, answer_text: 'orphan' }),
    ];
  ...
  it('should skip answers without question_id', () => {
    const questions = [makeQuestion({ id: 1, type: 'text' })];
    const userAnswers = [
      makeAnswer({ id: 1, question_id: 0, answer_text: 'no id' }),
    ];
