...
import { calculateTotalPoints, calculatePercentage, buildScoresMap, buildQuestionResult } from '@/utils/assessment/utils';
...
const useAssessmentReview = ({
  ...
  const getQuestionResult = useCallback(
    (question: Question): QuestionResult => buildQuestionResult(question, userAnswers[question.id], overrides),
