...
export const useAssessmentTakeStore = create<AssessmentTakeState & AssessmentTakeActions>()(
    immer((set) => ({
        ...
        setAssessmentTerminated: (terminated, reason = '') =>
            set((state) => {
        ...
        setTimeLeft: (timeLeft) =>
            set((state) => {
                state.timeLeft =
                    typeof timeLeft === 'function' ? timeLeft(state.timeLeft) : timeLeft;
            }),
        ...
        setShowFullscreenModal: (show) =>
            set((state) => {
                state.showFullscreenModal = show;
            }),

        setAssessmentCanStart: (canStart) =>
            set((state) => {
