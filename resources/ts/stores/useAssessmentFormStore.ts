...
export const useAssessmentFormStore = create<AssessmentFormState>()(
    immer((set) => ({
        ...
        addDeletedQuestionToHistory: (questionId, index, question) =>
            set((state) => {
        ...
        addDeletedChoiceToHistory: (choiceId, questionIndex, choiceIndex, choice, questionId) =>
            set((state) => {
        ...
        restoreQuestion: (deletedQuestion) =>
            set((state) => {
                state.questions.splice(deletedQuestion.index, 0, deletedQuestion.question);
                state.deletedQuestionIds = state.deletedQuestionIds.filter(
        ...
        restoreChoice: (deletedChoice) =>
            set((state) => {
                ...
                if (question?.choices) {
                    ...
                    state.deletedChoiceIds = state.deletedChoiceIds.filter(
                        (id) => id !== deletedChoice.id,
                    );
