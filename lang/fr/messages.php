...
return [
    ...
    // Grade Reports
    'grade_report' => 'Bulletin de notes',
    'grade_reports' => 'Bulletins de notes',
    'grade_reports_generated' => ':count bulletin(s) de notes généré(s) avec succès',
    'grade_report_validated' => 'Bulletin de notes validé avec succès',
    'grade_reports_validated_batch' => ':count bulletin(s) de notes validé(s) avec succès',
    'grade_report_published' => 'Bulletin de notes publié avec succès',
    'grade_reports_published_batch' => ':count bulletin(s) de notes publié(s) avec succès',
    'grade_report_pdf_not_found' => 'Fichier PDF introuvable pour ce bulletin',
    'general_remark_updated' => 'Appréciation générale mise à jour avec succès',
    'subject_remarks_updated' => 'Appréciations par matière mises à jour avec succès',
    'annual' => 'Annuel',
    ...
    'remark_satisfactory' => 'Passable',
    'remark_insufficient' => 'Insuffisant',
    'remark_no_grade' => 'Non noté',

    // Settings
    'settings_general_updated' => 'Les paramètres généraux ont été mis à jour.',
    'settings_bulletin_updated' => 'Les paramètres du bulletin ont été mis à jour.',
    'settings_logo_updated' => 'Le logo a été téléchargé avec succès.',
    'settings_logo_deleted' => 'Le logo a été supprimé.',
];
