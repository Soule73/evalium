...
return [
    ...
    'assessment_general_config' => [
        ...
        'release_results_after_grading_label' => 'Retenir les résultats jusqu’à la correction',
        'release_results_after_grading_help' => 'Si activé, les étudiants ne voient leurs résultats qu’après la correction manuelle complète du professeur.',
        'show_correct_answers_label' => 'Révéler les bonnes réponses après la correction',
        'show_correct_answers_help' => 'Les bonnes réponses ne sont visibles pour les étudiants qu’une fois la correction terminée.',
